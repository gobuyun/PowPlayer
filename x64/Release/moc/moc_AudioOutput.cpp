...
QT_MOC_LITERAL(1, 12, 11), // "onDataReady"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 6), // "source"
QT_MOC_LITERAL(4, 32, 8) // "Decoder*"

    },
    "AudioOutput\0onDataReady\0\0source\0"
    "Decoder*"
};
...
void AudioOutput::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 0:
            *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< Decoder* >(); break;
        }
    }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< Decoder**>(_v) = _t->getSource(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setSource(*reinterpret_cast< Decoder**>(_v)); break;
        default: break;
        }
